...
function validaRegistro(evt) {
    ...
    if (senha2.value == "") {
        caixa_senha2.innerHTML = "Favor preencher o campo Confirmar Senha";
        caixa_senha2.style.display = 'block';
        contErro += 1;
    } else if (senha2.value.length < 6) {
        caixa_senha2.innerHTML = "Favor preencher o campo Confirmar Senha com o mínimo de 6 caracteres";
        caixa_senha2.style.display = 'block';
        contErro += 1;
    } else {
    ...
    if (senha.value != "" && senha2.value != "" && senha.value != senha2.value) {
        caixa_senha2.innerHTML = "O campo Confirmar Senha é diferente do campo Senha";
        caixa_senha2.style.display = 'block';
        contErro += 1;
    }
